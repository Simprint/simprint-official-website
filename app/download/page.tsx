      ...
      <main className="pt-32 pb-24 relative z-10">
        <div className="container-main">
          ...
          <div className="text-center mb-20 reveal">
            <div className="text-sm font-bold text-neutral-500 uppercase tracking-[0.3em] mb-6">
              {t.download.label}
            </div>
            <h1 className="text-4xl md:text-5xl font-medium tracking-tight mb-6">{t.download.title}</h1>
            <p className="text-lg text-[#666666] font-light max-w-2xl mx-auto">{t.download.desc}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="download-card reveal" style={{ transitionDelay: '0.1s' }}>
              ...
              <p className="os-desc text-sm text-[#666666] mb-4">{t.download.windowsDesc}</p>
            ...
            <div className="download-card disabled reveal" style={{ transitionDelay: '0.2s' }}>
              ...
              <p className="os-desc text-sm text-[#666666] mb-4">{t.download.macosDesc}</p>
            ...
            <div className="download-card disabled reveal" style={{ transitionDelay: '0.3s' }}>
              ...
              <p className="os-desc text-sm text-[#666666] mb-4">{t.download.linuxDesc}</p>
